    ...
    AccessControlUpgradeable
{
    ...
    /// Intiialises the light client with a set of trust relayers and the first light client block.
    function initialize(
    ...
    /// Accepts a checkpoint block for a specific epoch from a trusted relayer.
    ...
    /// Returns the latest checkpoint block in the specified epoch, greater than
